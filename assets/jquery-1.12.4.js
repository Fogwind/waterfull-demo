...
(function (global, factory) {
    ...
    jQuery.extend = jQuery.fn.extend = function () {
        ...
        if (i === length) {
            target = this; // jQuery.extend -- 在jQuery 实例上上扩展；jQuery.fn.extend -- 在jQuery.fn（jQuery原型上）上扩展，即jQuery.prototype
            i--;
        }
                ...
                sortOrder = hasCompare ?
                    function (a, b) {
                        ...
                        if (compare & 1 ||
                            ...
                            if (a === document || a.ownerDocument === preferredDoc && contains(
                                    preferredDoc, a)) {
                                return -1;
                            }
                            if (b === document || b.ownerDocument === preferredDoc && contains(
                                    preferredDoc, b)) {
                                return 1;
                            }
    ...
    function genFx(type, includeWidth) {
        ...
        // if we include width, step value is 1 to do all cssExpand values -- ['Top', 'Right', 'Down', 'Left'],
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function (speed, easing, callback) {
            return this.animate(props, speed, easing, callback); // line 8017
        };
    });
